...
handlecloseSolutionDetailModal() {
  ...
  render() {
    return (<div>
             {this.props.resultSolutionList?<SolutionList userInfo={this.props.userInfo} ProblemOwnerID={this.props.userInfo.uid} submit_contract={this.props.submit_contract} data={this.props.resultSolutionList} match={this.props.match} showSolutionDetailModal={this.showSolutionDetailModal}/>:null} 
             <Modal
